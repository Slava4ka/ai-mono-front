...
export const DEFAULT_AVATAR = FEMALE_AVATAR_NAME;
export const DEFAULT_VOICE = getVideoUrl(DEFAULT_AVATAR);

export const rabbitStub = 'https://cdn.jsdelivr.net/gh/SH20RAJ/Sopplayer@main/sample.mp4';
